...
String locationFeedbackAllowedEndPoint = 'api/v1/location-feedback/allowed';
String locationFeedbackEndPoint = 'api/v1/location-feedback';
String sendFitnessEndPoint = 'api/v1/health-matrices';
String sendEmergencyRequestEndPoint = 'api/v1/emergency-request';
String messagesEndPoint = 'api/v1/sms';
