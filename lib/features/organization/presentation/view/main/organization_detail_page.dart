...
// //                           child:
// //                               const OrderTrackingScreen()) // Show this if tracking is enabled
// //                       : const TabStatus(
...
//                     ),
//                     const SectionHeading(title: 'Track status'),
//                     BlocBuilder<TrackCubit, bool>(
//                       builder: (context, isLocationTrackingEnabled) {
//                         print(
...
class _OrganizationDetailPageState extends State<OrganizationDetailPage> {
  ...
  void initState() {
    super.initState();
    fetchOrganizationData(widget.organizationId);
  }

  Future<void> fetchOrganizationData(int organizationId) async {
