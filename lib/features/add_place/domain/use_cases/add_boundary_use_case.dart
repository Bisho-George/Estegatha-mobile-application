...
class AddBoundaryUseCase extends UseCase<OrganizationBoundaryResponse, OrganizationBoundaryEntity> {
  final BoundaryRepo _boundaryRepo;

  AddBoundaryUseCase(this._boundaryRepo);

  @override
  Future<Either<Failure, OrganizationBoundaryResponse>> call(OrganizationBoundaryEntity param) async {
